  ...
  return (
    <div className="flex min-h-screen items-center justify-center p-4">
      ...
      >
        ...
        <button onClick={signInWithGoogle} className="mono-btn-secondary w-full mb-8 flex items-center justify-center gap-3">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button type="button" onClick={() => navigate('/')} className="mono-btn-secondary w-full">
            Cancel
          </button>
        </form>
        ...
        <button
          ...
          className="w-full text-center mt-6 mono-label text-muted-foreground hover:text-foreground transition-colors"
        >
